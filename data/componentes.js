...
<button type="submit" class="erp-btn erp-btn-primary" id="guardar" name="guardar">
  ...
  },
  {
    ...
    implementations: [
      ...
      { module: "Tipos de vehículos", agregar: 137, file: "cplus/views/mostrarTipoVehiculos.php", detail: "Las dos ramas del patrón, cada una con su propio div.row.mt-3 > div.col-md-12.text-end como último bloque del form: bajo empty($ver), Cancelar (a.erp-btn.erp-btn-secondary con bi-x-lg hacia incluir.php?agregar=137) ANTES del submit erp-btn erp-btn-primary, con los hidden _csrf, id y agregar=137 dentro del mismo bloque (líneas 147-160); en modo Ver, solo Volver con bi-arrow-left (líneas 161-169). Sigue el precedente de Riesgos 143: el Volver de consulta es acción del formulario y va al pie. Los otros seis módulos del barrido de QA (Embalajes, Métricas, Usuarios, Roles, Parafiscales y Sucursales) lo pintan encima de la tarjeta con el parcial cplus/views/partials/back-link.php: divergencia abierta el 2026-09-02" },
